...
<body class="text-center bg-white">
	...
	<div class="container invisible" id="contener-inicio-sesion-subdominio">
		...
		<div class="row">
			<div class="col-xs-12 col-md-12">
			    <img class="align-middle mb-5" src="sistema/img/<?php echo $_SESSION['web_subdominio_imagen'];?>" alt="" style="opacity:0.5;width:120px;height:120px;left:0px;position:relative;top:10px;">
   ...
   <!--Termino sesión sin dominio asignado-->
	...
	<script>
    	...
    	if(dominio_base!==path_url_actual){
				...
				$.ajax({
					...
					success: function(data) {
						...
						if (data.resultado === 'OK') 
						{
    							...
    							localStorage.setItem('dominio', JSON.stringify(dominio.toUpperCase()));
