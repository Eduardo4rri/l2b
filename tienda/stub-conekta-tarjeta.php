...
<body>
    <div class="opps">
        <div class="opps-header">
            ...
            <div class="opps-info">
                <div class="opps-brand"><img src="" id="imagen-tarjeta" alt="SPEI"></div>
        ...
        <div class="opps-instructions">
            ...
            <div class="opps-footnote">Pago realizado satisfactoriamente.</div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.resultado === 'OK') {
    					...
    					{
    					    $('#imagen-tarjeta').prop('src', '../sistema/img/pago_visa.png');
    					}
    					else if (pago.respuesta_banco_cuenta === 'mastercard' || pago.respuesta_banco_cuenta === 'mc')
    					{
    					    $('#imagen-tarjeta').prop('src', '../sistema/img/pago_mastercard.png');
    					}
    					else if (pago.respuesta_banco_cuenta === 'american_express')
    					{
    					    $('#imagen-tarjeta').prop('src', '../sistema/img/pago_american_express.png');
    					}
                    } else {
