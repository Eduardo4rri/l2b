                                        ...
                                        <table id="example" class="display nowrap table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input style="width: 20%" type="text" id="row-2-position" name="row-2-position" value="0"></td>
                                        ...
                                        <table id="table-pedidos" class="display nowrap table-striped table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td class="text-right">0</td>
                                                    <td class="text-center"><button class="btn btn-success" data-toggle="modal" data-target="#pedido-detalle"><i class="fas fa-eye"></i></button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
