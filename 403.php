	...
	<div class="container py-5">
		<div class="row">
			<div class="col-md-12 text-center">
				<p><i class="fa fa-ban fa-10x"></i><br /></p>
			</div>
			<div class="col-md-12 text-center">
			    <br>
				<h3>ERROR 403</h3>
				<br>
				<h3>¡No cuentas con los permisos necesarios para visualizar esta página!</h3>
				<br>
				<a class="btn btn-primary" href="javascript:history.back()"><i class="fa fa-arrow-left"></i> Regresar a la página anterior</a>
			</div>
		</div>
	</div>
</body>
